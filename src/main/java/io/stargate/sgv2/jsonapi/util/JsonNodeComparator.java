...
{
    private final static Comparator<JsonNode> ASC = new JsonNodeComparator();

    private final static Comparator<JsonNode> DESC = ASC.reversed();

    public static Comparator<JsonNode> ascending() { return ASC; }
    public static Comparator<JsonNode> descending() { return DESC; }
