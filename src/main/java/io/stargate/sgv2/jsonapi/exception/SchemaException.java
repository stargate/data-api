...
public class SchemaException extends RequestException {
  ...
  public enum Code implements ErrorCode<SchemaException> {
    ...
    CANNOT_VECTORIZE_UNKNOWN_COLUMNS, // converted from ErrorCodeV1
    DEPRECATED_AI_MODEL,
    ...
    OPEN_SEARCH_CORRUPT_SCHEMA,
    OPEN_SEARCH_INCOMPATIBLE_WITH_DENY_LIST,
    OPEN_SEARCH_MISSING_FIELD_MAPPINGS,
    OPEN_SEARCH_NOT_ENABLED_FOR_COLLECTION,
