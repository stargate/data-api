...
/**
 * XXX TODO - DELETE BEFORE MERGE amorton - 7 jan 2026 refactor NOTES: leaving this named
 * ThrowableToErrorMapper because we know it as that name.
 *
...
public final class ThrowableToErrorMapper {
  ...
  //
  //    // amorton - 7 jan 2026 - this could be better as pattern matching, but leaving until we
  // remove
  //    // the whole class.
  //
