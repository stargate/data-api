...
public class UpdateException extends RequestException {
  ...
  public enum Code implements ErrorCode<UpdateException> {
    ...
    UNSUPPORTED_UPDATE_OPERATION, // from ErrorCodeV1
    UNSUPPORTED_UPDATE_OPERATION_MODIFIER, // from ErrorCodeV1
    UNSUPPORTED_UPDATE_OPERATION_PARAM, // from ErrorCodeV1
    UNSUPPORTED_UPDATE_OPERATION_PATH, // from ErrorCodeV1
    UNSUPPORTED_UPDATE_OPERATION_TARGET, // from ErrorCodeV1
