...
/**
 *
 * @param vectorizeSort If <code>null</code> then the $vectorize field was not present in the sort clause, if ""
 *                      it was present but set to JSON null, otherwise it is the value provided.
 * @param lexicalSort If <code>null</code> then the $lexical field was not present in the sort clause, if ""
 *  *                      it was present but set to JSON null, otherwise it is the value provided.
