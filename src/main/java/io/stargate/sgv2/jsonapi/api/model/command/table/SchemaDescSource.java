...
/**
 * Describes where the schema description source of where this schema description was generated
 * from.
 */
public enum SchemaDescSource {
  ...
  /**
   * True if the scema description source is generated by the system, so from the DB schema, false
