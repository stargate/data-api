...
public interface ValidatableCommandClause {
   ...
   *
   * <p>Only implement this meho if the clause supports Collections, the default implementation is
   * to fail.
   *
   ...
   * TableSchemaObject}.
   *
   * <p>Only implement this meho if the clause supports Tables, the default implementation is to
   * fail.
   *
   ...
   *
   * <p>Only implement this meho if the clause supports Keyspaces, the default implementation is to
   * fail.
   *
   ...
   *
   * <p>Only implement this meho if the clause supports Databases, the default implementation is to
   * fail.
   *
