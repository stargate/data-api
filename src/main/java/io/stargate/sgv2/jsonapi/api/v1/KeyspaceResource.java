      ...
      content =
          @Content(
              ...
              examples = {
                ...
                @ExampleObject(ref = "createCollectionOpenSearch"),
                @ExampleObject(ref = "createCollectionOpenSearchCustomIndex"),
                @ExampleObject(ref = "createCollectionOpenSearchShardsAndReplicas"),
                @ExampleObject(ref = "createCollectionOpenSearchWithIndexing"),
                @ExampleObject(ref = "createCollectionOpenSearchNestedMapping"),
                @ExampleObject(ref = "findCollections"),
                @ExampleObject(ref = "findCollectionsExplain"),
