...
public record CreateDatabaseCommand(
  ...
  @Schema(name = "CreateDatabaseCommand.Options", description = "Options for creating a new database.")
  ...
  public record Replication(
      @NotNull @Pattern(regexp = "SimpleStrategy|NetworkTopologyStrategy") String strategy,
      @JsonAnyGetter @Schema(hidden = true) Map<String, Integer> strategyOptions) {}
}
