...
public enum SchemaDescBindingPoint {
  ...
  /**
   * Schema description used as the top-level response of a DDL command, such as listTables or
   * describeTable.
   */
  DDL_SCHEMA_OBJECT,

  /**
   * Schema description used within {@link #DDL_SCHEMA_OBJECT} as a reference to a schema object,
   * such as a column in a table.
   */
  DDL_USAGE,

  /**
   * Schema description used as the top-level response of a DML command, as part of the inline
   * schema for a read or write operation.
   */
  DML_SCHEMA_OBJECT,

  /**
   * Schema description used within {@link #DML_SCHEMA_OBJECT} as a reference to a schema object,
   * such as a column in a table.
   */
  DML_USAGE;
