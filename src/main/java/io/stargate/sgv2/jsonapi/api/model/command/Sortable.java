...
public interface Sortable {
  ...
  /**
   * Convenience ccessor for fully processed SortClause: will convert the intermediate JSON value to
   * a {@link SortClause} instance, including all validation. Delegates to {@link
  ...
  /**
   * Accessor for fully processed SortClause: will convert the intermediate JSON value to a {@link
   * SortClause} instance, including all validation
   *
