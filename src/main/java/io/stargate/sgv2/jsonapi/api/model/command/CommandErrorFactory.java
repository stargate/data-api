...
/**
 * Factory that creates a {@link CommandError} from an {@link APIException}.
 *
...
public class CommandErrorFactory {
   ...
   * <p>
   *
   * @param throwable Exception of any type. If not a {@link APIException} it will be wrapped in a
   *     {@link ServerException.Code#UNEXPECTED_SERVER_ERROR} .
