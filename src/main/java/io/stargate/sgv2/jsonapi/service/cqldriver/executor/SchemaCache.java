...
// *
// * <p>IMPORTANT: use {@link #getSchemaChangeListener()} and {@link
...
// *
// * <p>TODO: There should be a single level cache of keyspace,table not two levels, it will be
// easier
...
//
//  /**
//   * Gets a consumer to use with the {@link CQLSessionCache} to remove the schema cache entries
// when
...
//    }
//
//    var tableBasedSchemaCache = keyspaceCache.getIfPresent(new KeyspaceCacheKey(tenant,
// keyspace));
//    if (tableBasedSchemaCache != null) {
...
//
//  /**
//   * SchemaChangeListener for the schema cache, this is used to evict the cache entries when we
// get
...
//   * created because the listener will first listen for {@link
// SchemaChangeListener#onSessionReady}
...
//            tenant, tableMetadata.getKeyspace().asInternal(),
