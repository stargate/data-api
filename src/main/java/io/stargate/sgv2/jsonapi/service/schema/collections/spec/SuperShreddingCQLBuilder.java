 ...
 * <p>
 *  NOTE: this class is *not* used in production, it is only used by testing. It exists in the regular jar
 *  because it is easier to keep all the super shredding code in one place.
 *  See {@link SuperShreddingBuilder} for the testing process.
 * </p>
 * <p>
...
public class SuperShreddingCQLBuilder extends SuperShreddingBuilder<String, SuperShreddingCQLBuilder> {
  ...
  public List<SuperShreddingComponent<String>> buildInternal() {
    ...
    components.add(new SuperShreddingComponent<>(superShreddingDef.collection(), SuperShreddingComponentType.TABLE, tableCQL()));
