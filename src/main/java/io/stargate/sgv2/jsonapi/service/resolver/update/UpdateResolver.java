...
/**
 * A {@link ClauseResolver} for the update clause in a command and creates a {@link UpdateValuesCQLClause} for
 * the operation to use.
 * <p>
 * For now, the only implementation is for Tables. Future work will also create an implementation for Collections.
