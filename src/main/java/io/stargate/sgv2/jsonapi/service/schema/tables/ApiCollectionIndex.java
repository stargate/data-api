...
public class ApiCollectionIndex {
  //
  ...
  //    this.indexFunction = Objects.requireNonNull(indexFunction, "indexFunction must not be
  // null");
  //  }
  //
  ...
  //        ApiColumnDef apiColumnDef, CQLSAIIndex.IndexTarget indexTarget, IndexMetadata
  // indexMetadata)
