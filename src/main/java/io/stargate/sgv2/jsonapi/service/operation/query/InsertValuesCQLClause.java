...
/**
 * Interface for a class that can add the VALUES clause to a CQL query built using the Java Driver Query Builder.
 * <p>
 * This is the values part below:
 * <pre>
 * INSERT INTO users
 ...
 * </pre>
 * The function should use the {@link OngoingValues} to add the values to the statement, typically using the
