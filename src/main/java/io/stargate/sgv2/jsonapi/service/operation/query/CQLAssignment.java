...
/**
 * Interface for any class that can be used to assign values to a CQL Update statement build with
 * the Java Query Builder.
 *
 * <p>For example building the SET in the following CQL:
 *
 * <pre>
 *   UPDATE MyTable
 ...
 * </pre>
 *
 * <p>Always used with the {@link UpdateValuesCQLClause} to build the full clause.
 *
 * <p>The function should use the {@link OngoingAssignment} to add the values to the assignment,
