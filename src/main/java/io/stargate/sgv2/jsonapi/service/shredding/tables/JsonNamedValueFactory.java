...
//  @Inject
  ...
  public JsonNamedValueFactory(TableSchemaObject tableSchemaObject, JsonNodeDecoder jsonNodeDecoder) {
    this.tableSchemaObject = Objects.requireNonNull(tableSchemaObject, "tableSchemaObject must not be null");
  ...
  public JsonNamedValueContainer create(JsonNode document) {
    ...
    document
        ...
        .forEachRemaining(
            entry -> {
              var namedValue = new JsonNamedValue(
