 ...
 *
 * <p>While we don't do much with a database itself in the API, we do some commands like listing
 * keyspaces that conceptually belong to the database. So we have a schema object for it.
 *
 * <p>Currently only identified by the tenant.
 */
