 ...
 * <p>
 * e.g. API Validation should check that the fields listed in a filter exist on the target table.
 * <p>
 * TODO: this is POC until we work on the API tier validations for tables (and refactor collection validation)
 */
