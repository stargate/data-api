...
/**
 * Interface for a class that can add the SET clause to a CQL query built using the Java Driver Query Builder.
 * <p>
 * This is the set part below:
 * <pre>
 * UPDATE MyTable
 *   SET SomeColumn = 'SomeValue'
 *   WHERE columnName = B70DE1D0-9908-4AE3-BE34-5573E5B09F14;
 * </pre>
 * The function should use the {@link OngoingAssignment} to add the values to the statement, typically using the
