...
public class DocumentScoresDesc {
  ...
  @JsonPropertyOrder({DocumentConstants.Fields.RERANK_FIELD, DocumentConstants.Fields.VECTOR_EMBEDDING_FIELD})
  public record Scores(
      @JsonProperty(DocumentConstants.Fields.VECTOR_EMBEDDING_FIELD)
      float vector,
      @JsonProperty(DocumentConstants.Fields.RERANK_FIELD)
      float rerank) {
  }
}
