...
public record ChainedComparator(
    List<FindCollectionOperation.OrderBy> sortColumns, ObjectMapper objectMapper)
  ...
  public int compare(ReadDocument o1, ReadDocument o2) {
    ...
    for (FindCollectionOperation.OrderBy sortColumn : sortColumns()) {
      int compareValue =
