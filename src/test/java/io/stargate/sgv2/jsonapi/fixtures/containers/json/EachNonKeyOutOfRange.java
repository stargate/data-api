...
/**
 * Generate a fixture for combinations of the non primary key columns and adds the sets columns to
 * {@link JsonContainerFixture#outOfRangeAllColumns()}
 */
public class EachNonKeyOutOfRange extends JsonContainerFixtureBuilder {
  ...
  protected List<JsonContainerFixture> getInternal(
    ...
    // do not add a row that has all columns set, only do one at a time because initinity types need
    // to be tested.
