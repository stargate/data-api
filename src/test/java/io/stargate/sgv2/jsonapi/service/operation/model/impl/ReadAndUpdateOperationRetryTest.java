...
//
//    collectionReadCql =
//        "SELECT key, tx_id, doc_json FROM \"%s\".\"%s\" WHERE array_contains CONTAINS ? AND key =
// ? LIMIT 1"
//            .formatted(KEYSPACE_NAME, COLLECTION_NAME);
//
...
//                  .isEqualTo(
//                      "Failed to update documents with _id ['doc1']: Unable to complete
// transaction due to concurrent transactions");
//            });
//  }
//
//  @Test
...
//                  .isEqualTo(
//                      "Failed to update documents with _id ['doc1', 'doc2']: Unable to complete
// transaction due to concurrent transactions");
//            });
//  }
// }
