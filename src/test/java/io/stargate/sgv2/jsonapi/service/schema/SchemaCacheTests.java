...
import io.stargate.sgv2.jsonapi.service.cqldriver.executor.TableBasedSchemaCache;
...
//  private static final Optional<String> TENANT_ID =
//      Optional.of("tenant-id" + System.currentTimeMillis());
//
//  @Test
...
//    Assertions.assertThat(fixture.schemaCache.peekSchemaObject(TENANT_ID, "keyspace1", "table1"))
//        .as("TENANT_ID keyspace1 removed")
//        .isEmpty();
//    Assertions.assertThat(fixture.schemaCache.peekSchemaObject(TENANT_ID, "keyspace2", "table2"))
//        .as("TENANT_ID keyspace2 removed")
//        .isEmpty();
//    Assertions.assertThat(fixture.schemaCache.peekSchemaObject(notTenantId, "keyspace3", "table3"))
...
//    when(requestContext.getTenant()).thenReturn(Optional.of(tenantId));
//
...
//
//    Assertions.assertThat(actualUni).as("getSchemaObject returns non null").isNotNull();
//    var actualSchemaObject = actualUni.await().indefinitely();
//    Assertions.assertThat(actualSchemaObject)
//        .as("getSchemaObject returns the schema object from table cache")
//        .isSameAs(expectedSchemaObject);
//
//    Assertions.assertThat(fixture.schemaCache.peekSchemaObject(tenantId, keyspaceName, tableName))
