    ...
    public void catchTooBigDoc() {
      ...
      assertThat(e)
          ...
          .hasFieldOrPropertyWithValue(
              "code", DocumentException.Code.SHRED_DOC_LIMIT_VIOLATION.name())
          .hasMessageContaining("exceeds maximum allowed (" + docLimits.maxSize() + ")");
    }
    ...
    public void allowDocWithHugeObjectNoIndex() {
      ...
      assertThat(
              documentShredder.shred(
                  doc, null, indexProjector, "testCommand", testConstants.MISSING, null))
          .isNotNull();
    }
