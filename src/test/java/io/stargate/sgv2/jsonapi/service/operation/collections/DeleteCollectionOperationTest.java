...
public class DeleteCollectionOperationTest extends OperationTestBase {
  ...
  public void deleteWithId() {
    ...
    String collectionDeleteCql =
        "DELETE FROM \"%s\".\"%s\" WHERE key = ? IF tx_id = ?"
            .formatted(KEYSPACE_NAME, COLLECTION_NAME);
    SimpleStatement deleteStmt = SimpleStatement.newInstance(collectionDeleteCql, keyValue, tx_id);
    List<Row> deleteRows =
        Arrays.asList(new MockRow(DELETE_RESULT_COLUMNS, 0, Arrays.asList(byteBufferFrom(true))));

    AsyncResultSet deleteResults = new MockAsyncResultSet(DELETE_RESULT_COLUMNS, deleteRows, null);
  ...
  public void deleteOneAndReturnById() {
    ...
    DeleteCollectionOperation operation =
        DeleteCollectionOperation.deleteOneAndReturn(
            commandContext, findCollectionOperation, 3, DocumentProjector.defaultProjector());
    Supplier<CommandResult> execute =
        operation
            .execute(requestContext, queryExecutor)
            .subscribe()
  ...
  public void deleteOneAndReturnWithSort() {
    ...
    DeleteCollectionOperation operation =
        DeleteCollectionOperation.deleteOneAndReturn(
            COMMAND_CONTEXT, findCollectionOperation, 3, DocumentProjector.defaultProjector());
  ...
  public void deleteWithDynamicRetry() {
    ...
    SimpleStatement deleteStmt = SimpleStatement.newInstance(collectionDeleteCql, keyValue, tx_id1);
    List<Row> deleteRows =
        Arrays.asList(new MockRow(DELETE_RESULT_COLUMNS, 0, Arrays.asList(byteBufferFrom(false))));
    ...
    AsyncResultSet deleteResults2 = new MockAsyncResultSet(DELETE_RESULT_COLUMNS, deleteRows, null);
    when(queryExecutor.executeWrite(eq(requestContext), eq(deleteStmt)))
        .then(
            invocation -> {
              deleteCallCount.incrementAndGet();
    ...
    FindCollectionOperation findCollectionOperation =
        FindCollectionOperation.unsortedSingle(
            ...
            false);
    DeleteCollectionOperation operation =
        DeleteCollectionOperation.delete(COMMAND_CONTEXT, findCollectionOperation, 1, 2);
  ...
  public void deleteManyWithDynamic() {
    ...
    AsyncResultSet deleteResults1 = new MockAsyncResultSet(DELETE_RESULT_COLUMNS, deleteRows, null);
    when(queryExecutor.executeWrite(eq(requestContext), eq(deleteStmt)))
        .then(
            invocation -> {
              deleteCallCount.incrementAndGet();
    ...
    FindCollectionOperation findCollectionOperation =
        FindCollectionOperation.unsorted(
            ...
            false);
    DeleteCollectionOperation operation =
        DeleteCollectionOperation.delete(COMMAND_CONTEXT, findCollectionOperation, 2, 3);
    ...
    assertThat(result)
        .satisfies(
            commandResult -> {
              ...
              assertThat(result.errors().get(0).errorCode()).isEqualTo(DatabaseException.Code.FAILED_CONCURRENT_OPERATIONS.name());
              assertThat(result.errors().get(0).title()).isEqualTo("Failed to delete documents with _id ['doc1']: Failed to complete concurrent operations on the database");
            });
  }
  ...
  public void errorAll() {
    ...
    AsyncResultSet deleteResults3 = new MockAsyncResultSet(DELETE_RESULT_COLUMNS, deleteRows, null);
    when(queryExecutor.executeWrite(eq(requestContext), eq(deleteStmt)))
        .then(
            invocation -> {
              deleteCallCount.incrementAndGet();
    ...
    AsyncResultSet deleteResults4 = new MockAsyncResultSet(DELETE_RESULT_COLUMNS, deleteRows, null);
    ...
    assertThat(result)
        .satisfies(
            commandResult -> {
              ...
              assertThat(result.errors()).hasSize(1);
              assertThat(result.errors().get(0).errorCode()).isEqualTo(DatabaseException.Code.FAILED_CONCURRENT_OPERATIONS.name());
              assertThat(result.errors().get(0).title()).isEqualTo("Failed to delete documents with _id ['doc1', 'doc2']: Failed to complete concurrent operations on the database");
            });
  }
  ...
  public void deleteManyWithDynamicPaging() {
    ...
    final AtomicInteger selectCallCount = new AtomicInteger();
    when(queryExecutor.executeRead(eq(requestContext), eq(stmt), eq(Optional.empty()), anyInt()))
        .then(
            invocation -> {
              selectCallCount.incrementAndGet();
              return Uni.createFrom().item(mockResults);
