...
//      String collectionReadCql =
//          "SELECT key, tx_id, doc_json, query_text_values['username'],
// query_dbl_values['username'], query_bool_values['username'], query_null_values['username'],
// query_timestamp_values['username'] FROM \"%s\".\"%s\" WHERE array_contains CONTAINS ? LIMIT
// 10000"
//              .formatted(KEYSPACE_NAME, COLLECTION_NAME);
//
//      UUID tx_id = UUID.randomUUID();
...
//          new DBFilterBase.TextFilter("filter_me", DBFilterBase.MapFilterBase.Operator.EQ,
// "happy");
//      FindOperation findOperation =
...
//    public void happyPath() throws Exception {
//      String collectionReadCql =
//          "SELECT key, tx_id, doc_json FROM \"%s\".\"%s\" WHERE array_contains CONTAINS ? LIMIT
// 21"
//              .formatted(KEYSPACE_NAME, COLLECTION_NAME);
//
