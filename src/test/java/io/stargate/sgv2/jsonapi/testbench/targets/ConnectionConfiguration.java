 ...
 * @param port port to connect to, typically <code>8181</code> ore <code>443</code> but may be different when running integration tests.
 * @param basePath base path to the API, for Astra this is <code>/api/json/v1</code> when running locally is normally
 *                 <code>/v1</code>
*/
