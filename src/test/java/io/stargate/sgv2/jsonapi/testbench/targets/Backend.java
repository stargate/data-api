...
/**
 * A class of backend database the tests will be run against. This is not a partcular insance of a
 * DB to run against, for that see {@link Target}.
 *
 * <p>There is some different behavior between C* and Astra, and potentially in any future versions
 * of those products.
 */
