...
public interface JobLifeCycle {
    ...
    /**
     * Called to update the Job with any information it needs to run against the
     * particular target.
     * <p>
     * Typcially this means setting or updating the {@link Job#variables()} for things like a default keyspace
     * name or implementing naming restrictions.
     * </p>
     * <p>
     * NOTE: The target or Backend must set the <code>KEYSPACE_NAME</code> job variable
     * </p>
