...
public class JsonUtilTest {
  ...
  public void testObjectOrderedEquality() {
    ...
    assertThat(equalsOrdered("[{ \"a\":1, \"b\":2 }]", "[{ \"b\":2, \"a\":1 }]")).isFalse();
    assertThat(
            equalsOrdered("{ \"subdoc\" : { \"x\":0 } }", "{ \"subdoc\" : { \"x\":0, \"y\":5 } }"))
        .isFalse();
    assertThat(
            equalsOrdered(
  ...
  public void maybeEJSONValue() throws Exception {
    ...
    assertThat(JsonUtil.looksLikeEJsonValue(mapper.readTree("{\"$date\":123, \"x\":3}"))).isFalse();
  ...
  public void invalidEJSONDate() {
    ...
    assertThat(t)
        ...
        .hasMessageContaining(
            "Bad JSON Extension value to shred: Date ($date) needs to have Number value, had String (path '/')");
  }
}
