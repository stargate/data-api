...
public class TableMetadataTestUtil {
  ...
  public static Stream<TableAndColumn> removeAllColumns(
      TableMetadata tableMetadata, Collection<CqlIdentifier> columns) {
  ...
  public static Stream<TableAndColumn> removeAllPartitionKeys(
      TableMetadata tableMetadata, Collection<ColumnMetadata> columns) {
    return columns.stream()
        .map(
            column ->
  ...
  public static Stream<TableAndColumn> swapTypesAllColumns(
