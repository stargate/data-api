...
public class UDTIntegrationTest extends AbstractTableIntegrationTestBase {
  ...
  class CreateTable {
    ...
    @Test
    public void invalidUdtTypeKeyword() {
      assertNamespaceCommand(keyspaceName)
          .templated()
          .createTable(
              "invalidKeyword",
              // should be "udtName" not "udtType"
              // so error will treat this situation as missing udtName.
              Map.ofEntries(
                  Map.entry("id", "text"),
          ...
          .hasSingleApiError(
              ...
              SchemaException.class,
              "The user defined type name must not be empty");
    }
