  ...
  class AlterTableAddColumnsSuccess {
    ...
    public void shouldAddColumnsToTable() {
      ...
      assertNamespaceCommand(keyspaceName)
          ...
          .body("status.tables[0].definition.columns.list_type.valueType.type", equalTo("text"))
          .body("status.tables[0].definition.columns.set_type.type", equalTo("set"))
          .body("status.tables[0].definition.columns.set_type.valueType.type", equalTo("text"))
          .body("status.tables[0].definition.columns.map_type.type", equalTo("map"))
          .body("status.tables[0].definition.columns.map_type.keyType.type", equalTo("text"))
          .body("status.tables[0].definition.columns.map_type.valueType.type", equalTo("text"))
