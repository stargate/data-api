  ...
  class IndexingConfig {
    ...
    public void filterFieldInDenyOne() {
      ...
      given()
          ...
          .body(filterData)
          .when()
          .post(CollectionResource.BASE_PATH, keyspace, denyOneIndexingCollection)
          .then()
          .statusCode(200)
    ...
    public void filterVectorFieldInDenyAll() {
      ...
      given()
          ...
          .body(filterData)
          .when()
          .post(CollectionResource.BASE_PATH, keyspace, denyAllIndexingCollection)
          .then()
          .statusCode(200)
          .body("status", is(nullValue()))
          .body("data", is(nullValue()))
    ...
    public void filterFieldInDenyMany() {
      ...
      given()
          ...
          .body(filterData)
          .when()
          .post(CollectionResource.BASE_PATH, keyspace, denyManyIndexingCollection)
          .then()
          .statusCode(200)
          .body("status", is(nullValue()))
          .body("data", is(nullValue()))
    ...
    public void filterFieldInAllowOne() {
      ...
      given()
          ...
          .body(filterData)
          .when()
          .post(CollectionResource.BASE_PATH, keyspace, allowOneIndexingCollection)
          .then()
          .statusCode(200)
          .body("status", is(nullValue()))
          .body("errors", is(nullValue()))
    ...
    public void filterFieldInAllowMany() {
      ...
      given()
          ...
          .body(filterData)
          .when()
          .post(CollectionResource.BASE_PATH, keyspace, allowManyIndexingCollection)
          .then()
          .statusCode(200)
          .body("status", is(nullValue()))
          .body("errors", is(nullValue()))
