...
public class FilterClauseDeserializerTest {
  ...
  class Deserialize {
    ...
    public void happyPath() throws Exception {
      ...
      Assertions.assertThat(filterClause.comparisonExpressions()).hasSize(1).contains(expectedResult);
    }
    ...
    public void mustHandleEmpty() throws Exception {
      ...
      Assertions.assertThat(filterClause.comparisonExpressions()).hasSize(0);
    }
