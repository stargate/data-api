...
@WithTestResource(
    value = FeatureFlagDisabledIntegrationTest.TestResource.class,
    restrictToAnnotatedClass = false)
@TestClassOrder(ClassOrderer.OrderAnnotation.class)
public class FeatureFlagDisabledIntegrationTest extends AbstractKeyspaceIntegrationTestBase {
  // Need to be able to enable/disable the TABLES and RERANKING feature
