...
| Property                                                 | Type      | Default            | Description                                                                                                                                                                                         |
|----------------------------------------------------------|-----------|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `stargate.jsonapi.operations.keyspace`                   | `string`  | `default_keyspace` | The default Cassandra keyspace to use.                                                                                                                                                              |
| `stargate.jsonapi.operations.create-default-keyspace`    | `boolean` | `false`            | The flag to enable creation on default keyspace when a collection is created.                                                                                                                       |
