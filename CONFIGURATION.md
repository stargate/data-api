...
| `stargate.jsonapi.operations.database-config.ddl-retry-delay-seconds`   | `int` | `1`      | Delay time in seconds for DDL timeout.                                                                                                                                                              |
| `stargate.jsonapi.operations.database-config.ddl-delay-seconds`         | `int` | `2`      | Delay between create table and create index to get the schema sync.                                                                                                                                 |
