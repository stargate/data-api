...
* each document has 14 leaf values, with a maximum depth of 3
...
This means that setting cycles for each of the phases should be done using the: `write-cycles`, `read-single-cycles`, `read-multiple-cycles`, `update-cycles` and `delete-cycles`.
